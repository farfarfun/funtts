...
class BarkTTS(BaseTTS):
    ...
    def _prepare_synthesis_params(self, request: TTSRequest) -> Dict[str, Any]:
        ...
        params = {
            ...
            'waveform_temp': getattr(request, 'waveform_temp', self.config['waveform_temp']),
    ...
    def generate_with_effects(self, text: str, output_path: str, effects: List[str] = None) -> str:
        """
        生成带有特效的语音
    ...
    def get_engine_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "supported_languages": ["en", "zh", "de", "es", "fr", "hi", "it", "ja", "ko", "pl", "pt", "ru", "tr"],
            "features": [
                "高质量语音合成",
                "非语言声音生成",
                "背景音乐生成",
